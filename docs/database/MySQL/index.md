> 参考文章：[JavaGuide 索引总结1](https://snailclimb.gitee.io/javaguide/#/docs/database/MySQL Index)，[JavaGuide 索引总结2](https://snailclimb.gitee.io/javaguide/#/docs/database/数据库索引)
...
- [ ] [详细介绍](docs/dataStructures-algorithms/dataStructures/BTree.md)
...
![二级索引](../../../media/pictures/database/B+树二级索引(辅助索引).png)
